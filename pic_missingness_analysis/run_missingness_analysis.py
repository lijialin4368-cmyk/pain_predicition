...
RAW_INPUT_CSV = PROJECT_DIR / "data.csv"
VECTOR_INPUT_CSV = PROJECT_DIR / "data_vectorized.csv"
    ...
    readme.write_text(
        "\n".join(
            [
                ...
                "",
                f"- Covariates input (before imputation): `{RAW_INPUT_CSV}`",
                f"- Outcomes input: `{RAW_INPUT_CSV}`",
                f"- Reference cleaned file: `{VECTOR_INPUT_CSV}`",
                f"- Covariates chart: `covariates_missingness.png`",
                f"- Outcomes chart: `outcomes_missingness.png`",
                f"- Covariates table: `covariates_missingness.csv`",
                f"- Outcomes table: `outcomes_missingness.csv`",
            ]
        ),
        encoding="utf-8",
    )
