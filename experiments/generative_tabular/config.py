"""Configuration for CTGAN/TVAE tabular generation experiments."""
...
CLASSIFICATION_POSITIVE_MULTIPLIER = 1.0
REGRESSION_GENERATED_MULTIPLIER = 1.0
...
META_TASK_COL = "__meta_generation_task"
...
SYNTHESIZER_FILENAME = "synthesizer.pkl"
