...
PREDICT_OUTPUT_PATH = OUTPUT_DIR / "inference_predictions.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run batch inference with the raw-data RF baseline.")
    parser.add_argument(
        "--data-path",
        type=Path,
        default=DATA_PATH,
        help="Input CSV path for inference.",
    )
    parser.add_argument(
        "--model-path",
        type=Path,
